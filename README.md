...
5. Запрашиваем у пользователя функцию, действие и данные для действия над ней.
   <br> а. Вычисление значения функции по x
   <br> б. Табуляция функции по диапозону и шагу (вычисляем значения и подставляем в таблицу)
   <br> в. Построить график функции
   		 <br>  Создаём двумерный массив символов
   		 <br>  Заполняем * в точки с координатами (x,f(x)) остальное пробеламии и осями координат
   		 <br>  Печатаем
7. **Конец**

### Блок-схема
![Блок-схема алгоритма](22Lab_schema.jpg)
...
# 3. Результаты работы программы
 <br>Выберите функцию:
 <br>0) Y(x) = e ^ (cos x) * cos(sin(x))
 <br>
 <br>         |x>0.75                        x+1
 <br>1)V(x) = |0 <= x <= 0.75        1 - pow(x,5)
   <br>       |x < 0                 x + ln(|cos(x)|)
 <br>0
 <br>Выберите действие:
 <br>1) Вычислить значение
 <br>2) Протабулировать функцию
 <br>3) Построить график функции
 <br>4) Вычислить сумму максимального и минимального значений функции
 <br>3
 <br>Введите диапазон и шаг через пробел: -2 2 0,1
                                               ******
                                              *  |   *
                                            **   |    **
                                           *     |      *
